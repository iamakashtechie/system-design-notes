...
export default withPwa(
  defineConfig({
    ...
    head: [
      ...
      ['meta', { name: 'apple-mobile-web-app-title', content: 'SysDesign Notes' }],
      ['meta', { name: 'application-name', content: 'System Design Notes' }],
    ...
    pwa: {
      ...
      manifest: {
        ...
        short_name: 'SysDesign Notes',
        description: "Comprehensive notes based on System Design Interview (Vol 1 & 2) by Alex Xu",
        theme_color: '#3b82f6',
