---
title: Ch 19 · Distributed Message Queue
---
...
![message-queue-components](/images/19-distributed-message-queue/message-queue-components.png)
...
![point-to-point-model](/images/19-distributed-message-queue/point-to-point-model.png)
...
![publish-subscribe-model](/images/19-distributed-message-queue/publish-subscribe-model.png)
...
![partitions](/images/19-distributed-message-queue/partitions.png)
...
![consumer-groups](/images/19-distributed-message-queue/consumer-groups.png)
...
![high-level-architecture](/images/19-distributed-message-queue/high-level-architecture.png)
...
![wal-example](/images/19-distributed-message-queue/wal-example.png)
...
![message-structure](/images/19-distributed-message-queue/message-structure.png)
...
![routing-layer](/images/19-distributed-message-queue/routing-layer.png)
...
![routing-layer-producer](/images/19-distributed-message-queue/routing-layer-producer.png)
...
![batch-size-throughput-vs-latency](/images/19-distributed-message-queue/batch-size-throughput-vs-latency.png)
...
![consumer-example](/images/19-distributed-message-queue/consumer-example.png)
...
![consumer-flow](/images/19-distributed-message-queue/consumer-flow.png)
...
![consumer-rebalancing](/images/19-distributed-message-queue/consumer-rebalancing.png)
...
![consumer-rebalance-example](/images/19-distributed-message-queue/consumer-rebalance-example.png)

Let's explore what happens when a consumer joins a group:

![consumer-join-group-usecase](/images/19-distributed-message-queue/consumer-join-group-usecase.png)
...
![consumer-leaves-group-usecase](/images/19-distributed-message-queue/consumer-leaves-group-usecase.png)
...
![consumer-no-heartbeat-usecase](/images/19-distributed-message-queue/consumer-no-heartbeat-usecase.png)

### **State storage**

The state storage stores mapping between partitions and consumers, as well as the last consumed offsets for a partition.

![state-storage](/images/19-distributed-message-queue/state-storage.png)
...
![zookeeper](/images/19-distributed-message-queue/zookeeper.png)
...
![replication-example](/images/19-distributed-message-queue/replication-example.png)
...
![in-sync-replicas-example](/images/19-distributed-message-queue/in-sync-replicas-example.png)
...
![ack-all](/images/19-distributed-message-queue/ack-all.png)
...
![ack-1](/images/19-distributed-message-queue/ack-1.png)
...
![ack-0](/images/19-distributed-message-queue/ack-0.png)
...
![broker-failure-recovery](/images/19-distributed-message-queue/broker-failure-recovery.png)
...
![broker-replica-redistribution](/images/19-distributed-message-queue/broker-replica-redistribution.png)
...
![partition-example](/images/19-distributed-message-queue/partition-exmaple.png)

Decreasing the number of partitions is more involved:

![partition-decrease](/images/19-distributed-message-queue/partition-decrease.png)
...
![at-most-once](/images/19-distributed-message-queue/at-most-once.png)
...
![at-least-once](/images/19-distributed-message-queue/at-least-once.png)
...
![exactly-once](/images/19-distributed-message-queue/exactly-once.png)
...
![message-filtering](/images/19-distributed-message-queue/message-filtering.png)
...
![delayed-message-implementation](/images/19-distributed-message-queue/delayed-message-implementation.png)
