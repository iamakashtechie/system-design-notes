...
![HLD](/images/16-proximity-service/high-level-design.png)
...
![2D](/images/16-proximity-service/2d-search.png)
...
- An optimal apporach is to reprsent the two-dimensional data into one dimension using geospatial indexing.
  ...
  ![2D](/images/16-proximity-service/geospatial-index-types.png)

### **Option 2: Evenly Divided Grid**

  ![Even Grid](/images/16-proximity-service/even-grid.png)
...
- Repeat this subdivision
  ...
  ![Geohash](/images/16-proximity-service/geohash.png)
    ![Geohash](/images/16-proximity-service/geohash-1.png)
...
- The right precision is chosen by using the minimal geohash length according to the table.
  ![Geohash Radius](/images/16-proximity-service/geohash-radius-mapping.png)

- Geohash guarantees that the longer a shared prefix is between two geohashes, the closer they are.

- **Challenges**:
  ![Boundary Issue](/images/16-proximity-service/boundary-issue.png)
...
### **Option 4: Quadtree**
  ...
  ![Quadtree](/images/16-proximity-service/quadtree.png)
  ...
  ![Building Quadtree](/images/16-proximity-service/building-quadtree.png)
...
- **Efficient for k-nearest search queries** (e.g., find the closest gas station).
  ...
  ![Real World Quadtree](/images/16-proximity-service/realworld-quadtree.png)
...
It maps a sphere to a !D index based on Hilbert curve.Two points that are close to each other on the Hilbert curve are close in 1D space.
  ...
  ![Hilbert curve](/images/16-proximity-service/hilbert-curve.png)
    ![Geofence](/images/16-proximity-service/geofence.png)
...
### **Final System Architecture**
  ...
  ![Final Design](/images/16-proximity-service/final-design.png)
