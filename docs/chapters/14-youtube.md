...
![High Level Design](/images/14-youtube/high-level-design.png)
...
- **Video Upload (Steps):**
    ...
    ![Video Upload Flow](/images/14-youtube/video-uploading-flow.png)
...
- **Metadata Upload (Steps):**
    ...
    ![Metadata Upload](/images/14-youtube/metadata-upload.png)
...
![Video Streaming Flow](/images/14-youtube/video-streaming-flow.png)
...
![DAG Video Transcoding](/images/14-youtube/dag-video-transcoding.png)
...
![Video Transcoding](/images/14-youtube/video-transcoding-architecture.png)

1. **Preprocessor:** Splits videos into smaller chunks (GOP alignment). It has 4 responsibilities.

    ![DAG Config](/images/14-youtube/dag-config.png)
...
2. **DAG Scheduler:** Organizes tasks into sequential or parallel stages.
    ![DAG Scheduler](/images/14-youtube/dag-scheduler.png)
...
contains 3 queues and a task scheduler.
    ![Resource Manager](/images/14-youtube/resource-manager.png)
...
4. **Task Workers:** Perform transcoding and other operations.
    ![Task Worker](/images/14-youtube/task-worker.png)
...
1. **Parallel Video Uploads:** Split videos into smaller chunks for faster, resumable uploads.
    ...
    ![Video Split](/images/14-youtube/video-split.png)
...
3. **Parallel Processing:** Decouple modules using message queues for high parallelism.
    ...
    ![Message Queue](/images/14-youtube/message-queue1.png)
    <img src="/images/14-youtube/message-queue2.png" alt="Message Queue" height="170" width="500">

### Safety Optimizations
1. **Pre-Signed URLs:** Restrict video uploads to authorized users.

    ![Pre Signed](/images/14-youtube/pres-signed-urls.png)
