---
title: Ch 9 · Design a Web Crawler
---
...
### Components
<p align="center">
![Web Crawler Architecture](/images/09-web-crawler/web-crawler-architecture.png)
</p>
...
- **Politeness:** 
    ...
    - Each downloader thread has a separate FIFO queue and only downloads URLs from that queue.
        ...
        ![Politeness](/images/09-web-crawler/politeness.png)
...
- **Priority:** 
    - Assign higher priority to important pages (e.g., by PageRank or update frequency).
        ...
        ![Politeness](/images/09-web-crawler/prioritizer.png)
...
- Example: Plug in a module to monitor web content for copyright violations.
    ...
    ![Politeness](/images/09-web-crawler/extensibility.png)
---
