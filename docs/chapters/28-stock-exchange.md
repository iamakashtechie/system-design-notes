...
![world-stock-exchanges](/images/28-stock-exchange/world-stock-exchanges.png)
...
![high-level-design](/images/28-stock-exchange/high-level-design.png)
...
![sequencer](/images/28-stock-exchange/sequencer.png)
...
![client-gateway](/images/28-stock-exchange/client-gateway.png)
...
![client-gateways](/images/28-stock-exchange/client-gateways.png)
...
![market-data](/images/28-stock-exchange/market-data.png)

#### Reporting flow
The reporter is not on the critical path, but it is an important component nevertheless.

![reporting-flow](/images/28-stock-exchange/reporting-flow.png)
...
![product-order-execution-data-model](/images/28-stock-exchange/product-order-execution-data-model.png)
...
![order-book-execution](/images/28-stock-exchange/order-book-execution.png)
...
![order-book-impl](/images/28-stock-exchange/order-book-impl.png)
...
![mmap-bus](/images/28-stock-exchange/mmap-bus.png)
...
![application-loop](/images/28-stock-exchange/application-loop.png)
...
### **Event sourcing**
Event sourcing is discussed in-depth in the [digital wallet chapter](./27-digital-wallet). Reference it for all the details.

In a nutshell, instead of storing current states, we store immutable state transitions:

![event-sourcing](/images/28-stock-exchange/event-sourcing.png)
...
![design-so-far](/images/28-stock-exchange/design-so-far.png)
...
![sequencer-deep-dive](/images/28-stock-exchange/sequencer-deep-dive.png)
...
![leader-election](/images/28-stock-exchange/leader-election.png)
...
![replication-across-servers](/images/28-stock-exchange/replication-across-servers.png)

Example leader-election terms:

![leader-election-terms](/images/28-stock-exchange/leader-election-terms.png)
...
![determinism](/images/28-stock-exchange/determinism.png)
...
![market-data-publisher](/images/28-stock-exchange/market-data-publisher.png)
