---
title: Ch 20 · Metrics Monitoring and Alerting System
---
...
![metrics-monitoring-core-components](/images/20-metrics-monitoring/metrics-monitoring-core-components.png)
...
![metrics-example-1](/images/20-metrics-monitoring/metrics-example-1.png)

The data can be identified by the following table:

![metrics-example-1-data](/images/20-metrics-monitoring/metrics-example-1-data.png)
...
![time-series-data-example](/images/20-metrics-monitoring/time-series-data-example.png)

A good way to visualize how data looks like:

![time-series-data-viz](/images/20-metrics-monitoring/time-series-data-viz.png)
...
![influxdb-scale](/images/20-metrics-monitoring/influxdb-scale.png)
...
![high-level-design](/images/20-metrics-monitoring/high-level-design.png)
...
![metrics-collection](/images/20-metrics-monitoring/metrics-collection.png)

There are two ways to implement metrics collection - pull or push.

Here's how the pull model might look like:

![pull-model-example](/images/20-metrics-monitoring/pull-model-example.png)
...
![service-discovery-example](/images/20-metrics-monitoring/service-discovery-example.png)

Here's a detailed explanation of the metrics collection flow:

![metrics-collection-flow](/images/20-metrics-monitoring/metrics-collection-flow.png)
...
![consistent-hash-ring](/images/20-metrics-monitoring/consistent-hash-ring.png)

With the push model, on the other hand, services push their metrics to the metrics collector proactively:

![push-model-example](/images/20-metrics-monitoring/push-model-example.png)
...
![metrics-collector-agent](/images/20-metrics-monitoring/metrics-collector-agent.png)
...
![metrics-transmission-pipeline](/images/20-metrics-monitoring/metrics-transmission-pipeline.png)
...
![queuing-mechanism](/images/20-metrics-monitoring/queuing-mechanism.png)
...
![metrics-collection-kafka](/images/20-metrics-monitoring/metrics-collection-kafka.png)
...
![cache-layer-query-service](/images/20-metrics-monitoring/cache-layer-query-service.png)
...
![double-delta-encoding](/images/20-metrics-monitoring/double-delta-encoding.png)
...
![alerting-system](/images/20-metrics-monitoring/alerting-system.png)
...
![grafana-dashboard](/images/20-metrics-monitoring/grafana-dashboard.png)
...
![final-design](/images/20-metrics-monitoring/final-design.png)
