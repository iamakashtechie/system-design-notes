...
![high-level-flow](/images/26-payment-system/high-level-flow.png)

### **Pay-in flow**
Here's the high-level overview of the pay-in flow:

![pay-in-flow-high-level](/images/26-payment-system/payin-flow-high-level.png)
...
![hosted-payment-page](/images/26-payment-system/hosted-payment-page.png)
...
![hosted-payment-page-workflow](/images/26-payment-system/hosted-payment-page-workflow.png)
...
![settlement-report](/images/26-payment-system/settlement-report.png)
...
![single-receiver](/images/26-payment-system/single-receiver.png)

Multiple receivers - multiple receivers subscribe to the same topic, but messages are forwarded to all of them:

![multiple-receiver](/images/26-payment-system/multiple-receiver.png)
...
![failed-payments](/images/26-payment-system/failed-payments.png)
...
![retry-mechanism](/images/26-payment-system/retry-mechanism.png)
...
![idempotency-example](/images/26-payment-system/idempotency-example.png)
