...
![digital-wallet](/images/27-digital-wallet/digital-wallet.png)
...
![wallet-service](/images/27-digital-wallet/wallet-service.png)
...
![distributed-transactions-relational-dbs](/images/27-digital-wallet/distributed-transactions-relational-dbs.png)

Here's how the two-phase commit (2PC) protocol works:

![2pc-protocol](/images/27-digital-wallet/2pc-protocol.png)
...
![try-phase](/images/27-digital-wallet/try-phase.png)
...
![confirm-phase](/images/27-digital-wallet/confirm-phase.png)
...
![cancel-phase](/images/27-digital-wallet/cancel-phase.png)
...
![phase-status-tables](/images/27-digital-wallet/phase-status-tables.png)
...
![unbalanced-state](/images/27-digital-wallet/unbalanced-state.png)
...
![out-of-order-execution](/images/27-digital-wallet/out-of-order-execution.png)
...
![saga](/images/27-digital-wallet/saga.png)
...
![event-sourcing](/images/27-digital-wallet/event-sourcing.png)

Here's a dynamic view of event sourcing:

![dynamic-event-sourcing](/images/27-digital-wallet/dynamic-event-sourcing.png)

For our wallet service, the commands are balance transfer requests. We can put them in a FIFO queue, such as Kafka:

![command-queue](/images/27-digital-wallet/command-queue.png)

Here's the full picture:

![wallet-service-state-machine](/images/27-digital-wallet/wallet-service-state-macghine.png)
...
![historical-states](/images/27-digital-wallet/historical-states.png)
...
![cqrs-architecture](/images/27-digital-wallet/cqrs-architecture.png)
...
![mmap-optimization](/images/27-digital-wallet/mmap-optimization.png)
...
![rocks-db-approach](/images/27-digital-wallet/rocks-db-approach.png)
...
![snapshot-approach](/images/27-digital-wallet/snapshot-approach.png)
...
![raft-replication](/images/27-digital-wallet/raft-replication.png)
...
![polling-approach](/images/27-digital-wallet/polling-approach.png)
...
![reverse-proxy](/images/27-digital-wallet/reverse-proxy.png)
...
![push-state-machines](/images/27-digital-wallet/push-state-machines.png)
...
![sharded-raft-groups](/images/27-digital-wallet/sharded-raft-groups.png)
