---
title: Ch 24 · S3-like Object Storage
---
...
![storage-comparison](/images/24-object-storage/storage-comparison.png)
...
![object-store-vs-unix](/images/24-object-storage/object-store-vs-unix.png)

By separating metadata from file contents, we can scale the different stores independently:

![bucket-and-object](/images/24-object-storage/bucket-and-object.png)

### **High-level design**

![high-level-design](/images/24-object-storage/high-level-design.png)
...
![uploading-object](/images/24-object-storage/uploading-object.png)
...
![download-object](/images/24-object-storage/download-object.png)
...
![data-store-interactions](/images/24-object-storage/data-store-interactions.png)

The data store's main components:

![data-store-main-components](/images/24-object-storage/data-store-main-components.png)
...
![virtual-cluster-map](/images/24-object-storage/virtual-cluster-map.png)
...
![data-persistence-flow](/images/24-object-storage/data-persistence-flow.png)
...
![consistency-vs-latency](/images/24-object-storage/consistency-vs-latency.png)
...
![wal-optimization](/images/24-object-storage/wal-optimization.png)
...
![updated-data-persistence-flow](/images/24-object-storage/updated-data-persistence-flow.png)
...
![failure-domain-isolation](/images/24-object-storage/failure-domain-isolation.png)
...
![erasure-coding](/images/24-object-storage/erasure-coding.png)
...
![erasure-coding-across-failure-domains](/images/24-object-storage/erasure-coding-across-failure-domains.png)
...
![erasure-coding-vs-replication](/images/24-object-storage/erasure-coding-vs-replication.png)
...
![checksums-for-correctness](/images/24-object-storage/checksums-for-correctness.png)
...
![metadata-data-model](/images/24-object-storage/metadata-data-model.png)
...
![object-versioning](/images/24-object-storage/object-versioning.png)
...
![deleting-versioned-object](/images/24-object-storage/deleting-versioned-object.png)
...
![multipart-upload](/images/24-object-storage/multipart-upload.png)
...
![compaction](/images/24-object-storage/compaction.png)
