---
title: Ch 22 · Hotel Reservation System
---
...
![qps-estimation](/images/22-hotel-reservation/qps-estimation.png)
...
![schema-design](/images/22-hotel-reservation/schema-design.png)
...
![status-state-machine](/images/22-hotel-reservation/status-state-machine.png)
...
![high-level-design](/images/22-hotel-reservation/high-level-design.png)
...
![updated-schema](/images/22-hotel-reservation/updated-schema.png)
...
![double-booking-single-user](/images/22-hotel-reservation/double-booking-single-user.png)
...
![idempotency](/images/22-hotel-reservation/idempotency.png)
...
![unique-constraint-violation](/images/22-hotel-reservation/unique-constraint-violation.png)

What if there are multiple users making the same reservation?

![double-booking-multiple-users](/images/22-hotel-reservation/double-booking-multiple-users.png)
...
![pessimistic-locking](/images/22-hotel-reservation/pessimistic-locking.png)
...
![optimistic-locking](/images/22-hotel-reservation/optimistic-locking.png)
...
![database-constraint](/images/22-hotel-reservation/database-constraint.png)
...
![database-sharding](/images/22-hotel-reservation/database-sharding.png)
...
![inventory-cache](/images/22-hotel-reservation/inventory-cache.png)
...
![microservices-vs-monolith](/images/22-hotel-reservation/microservices-vs-monolith.png)
...
![atomicity-monolith](/images/22-hotel-reservation/atomicity-monolith.png)

It's more challenging, however, to guarantee this atomicity when the operation spans across multiple services:

![microservice-non-atomic-operation](/images/22-hotel-reservation/microservice-non-atomic-operation.png)
