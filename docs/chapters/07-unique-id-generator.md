---
title: Ch 7 · Design a Unique ID Generator
---
...
- **Approach:** Use database `auto_increment` with step increments (e.g., `+k` for k servers).
    ...
    <p align="left">
    ![Multi Master](/images/07-unique-id-generator/multi-master.png)
    </p>
...
- **Approach:** 
    ...
    - UUIDs can be generated independently without coordination between servers
        ...
        <p align="left">
        ![UUID generator](/images/07-unique-id-generator/uuid.png)
        </p>
...
- **Approach:** Use a centralized database server to increment and assign IDs.
    ...
    <p align="left">
    ![UUID generator](/images/07-unique-id-generator/ticket-server.png)
    </p>
...
- **Approach:** 
    ...
    ![Snowflake approach](/images/07-unique-id-generator/twitter-snowflake.png)

    ![Snowflake ID breakdow](/images/07-unique-id-generator/snowflake-id-breakdown.png)
