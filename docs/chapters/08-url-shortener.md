---
title: Ch 8 · Design a URL Shortener
---
...
2. **URL Redirecting:**  
   ...
   - Returns: `longURL` for redirection.
    ...
    <p align="center">
    ![URL Redirection](/images/08-url-shortener/url-redirection.png)
    </p>
...
### URL Shortening
<p align="center">
    ![URL Shortening](/images/08-url-shortener/url-shortening.png)
</p>
...
- `longURL`.
    ...
    ![Table Schema](/images/08-url-shortener/table-schema.png)
...
- Use hash functions like CRC32, MD5, or SHA-1.
    ...
    ![Hash Function](/images/08-url-shortener/hash-function.png)
...
- Resolve collisions with **Bloom Filters** for efficient lookup.
    ...
    <p align="center">
    ![URL Lookup](/images/08-url-shortener/url-lookup.png)
    </p>
...
<p align="center">
    ![URL Shortening](/images/08-url-shortener/url-shortening-flow.png)
</p>
...
<p align="center">
    ![URL Shortening](/images/08-url-shortener/url-redirecting-flow.png)
</p>
