---
title: Ch 21 · Ad Click Event Aggregation
---
...
![digital-advertising-example](/images/21-ad-click-aggregation/digital-advertising-example.png)
...
![high-level-design-1](/images/21-ad-click-aggregation/high-level-design-1.png)
...
![high-level-design-2](/images/21-ad-click-aggregation/high-level-design-2.png)
...
![atomic-commit](/images/21-ad-click-aggregation/atomic-commit.png)

For the aggregation service, using the MapReduce framework is a good option:

![ad-count-map-reduce](/images/21-ad-click-aggregation/ad-count-map-reduce.png)

![top-100-map-reduce](/images/21-ad-click-aggregation/top-100-map-reduce.png)
...
![map-node](/images/21-ad-click-aggregation/map-node.png)
...
![reduce-node](/images/21-ad-click-aggregation/reduce-node.png)
...
![use-case-1](/images/21-ad-click-aggregation/use-case-1.png)

 - Ads are partitioned using `ad_id % 3`

**Use-case 2 - return top N most clicked ads**:

![use-case-2](/images/21-ad-click-aggregation/use-case-2.png)
...
![lambda-architecture](/images/21-ad-click-aggregation/lambda-architecture.png)

Kappa architecture:

![kappa-architecture](/images/21-ad-click-aggregation/kappa-architecture.png)
...
![recalculation-example](/images/21-ad-click-aggregation/recalculation-example.png)
...
![watermark-technique](/images/21-ad-click-aggregation/watermark-technique.png)
...
![watermark-2](/images/21-ad-click-aggregation/watermark-2.png)
...
![tumbling-window](/images/21-ad-click-aggregation/tumbling-window.png)

As well as a sliding window for the top N clicked ads in M minutes aggregation:

![sliding-window](/images/21-ad-click-aggregation/sliding-window.png)
...
![data-duplication-example](/images/21-ad-click-aggregation/data-duplication-example.png)
...
![data-duplication-example-2](/images/21-ad-click-aggregation/data-duplication-example-2.png)
...
![data-duplication-example-3](/images/21-ad-click-aggregation/data-duplication-example-3.png)
...
![scale-consumers](/images/21-ad-click-aggregation/scale-consumers.png)

How do we scale the aggregation service:

![aggregation-service-scaling](/images/21-ad-click-aggregation/aggregation-service-scaling.png)
...
![multi-threading-example](/images/21-ad-click-aggregation/multi-threading-example.png)
...
![cassandra-scalability](/images/21-ad-click-aggregation/cassandra-scalability.png)
...
![hotspot-issue](/images/21-ad-click-aggregation/hotspot-issue.png)
...
![fault-tolerance-example](/images/21-ad-click-aggregation/fault-tolerance-example.png)
...
![fault-tolerance-recovery-example](/images/21-ad-click-aggregation/fault-tolerance-recovery-example.png)
...
![reconciliation-flow](/images/21-ad-click-aggregation/reconciliation-flow.png)
...
![alternative-design](/images/21-ad-click-aggregation/alternative-design.png)
