---
title: Ch 10 · Design a Notification System
---
...
2. **Contact Info Gathering:**
   ![Contact Info Gathering](/images/10-notification-system/contact-info-gathering.png)
...
3. **Notification Sending Flow:**
   ...
   ![High Level Design](/images/10-notification-system/high-level-design.png)
...
### Improved Design
   ...
   ![Improved Design](/images/10-notification-system/improved-design.png)
...
### Reliability
1. **Prevent Data Loss:** 
   ![Data Loss](/images/10-notification-system/data-loss.png)
...
### Additional Components
   ![Events Tracking](/images/10-notification-system/events-tracking.png)
...
### Notification Flow
   ...
   ![Updated Design](/images/10-notification-system/updated-design.png)
