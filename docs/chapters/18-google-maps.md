---
title: Ch 18 · Design Google Maps
---
...
![partitioning-system](/images/18-google-maps/partitioning-system.png)
...
![map-projections](/images/18-google-maps/map-projections.png)
...
![geohashing](/images/18-google-maps/geohashing.png)
...
![road-representation](/images/18-google-maps/road-representation.png)
...
![routing-tiles](/images/18-google-maps/routing-tiles.png)
...
![map-routing-hierarchical](/images/18-google-maps/map-routing-hierarchical.png)
...
![high-level-design](/images/18-google-maps/high-level-design.png)

### **Location service**

![location-service](/images/18-google-maps/location-service.png)
...
![location-update-batches](/images/18-google-maps/location-update-batches.png)
...
![static-map-tiles](/images/18-google-maps/static-map-tiles.png)
...
![cdn-vs-no-cdn](/images/18-google-maps/cdn-vs-no-cdn.png)
...
![map-tile-url-calculation](/images/18-google-maps/map-tile-url-calculation.png)
...
![user-location-data-row](/images/18-google-maps/user-location-data-torw.png)
...
![precomputed-map-tile-image](/images/18-google-maps/precomputed-map-tile-image.png)
...
![location-service-diagram](/images/18-google-maps/location-service-diagram.png)
...
![user-location-row-example](/images/18-google-maps/user-location-row-example.png)
...
![location-update-streaming](/images/18-google-maps/location-update-streaming.png)
...
![zoom-level-increases](/images/18-google-maps/zoom-level-increases.png)
...
![navigation-service](/images/18-google-maps/navigation-service.png)
...
![shortest-path-service](/images/18-google-maps/shortest-path-service.png)
...
![adaptive-eta-data-storage](/images/18-google-maps/adaptive-eta-data-storage.png)
...
![final-design](/images/18-google-maps/final-design.png)
