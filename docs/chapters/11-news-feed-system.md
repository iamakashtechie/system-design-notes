---
title: Ch 11 · Design a News Feed System
---
...
### Feed Publishing
   ...
   ![Feed Publishing](/images/11-news-feed-system/feed-publishing.png)
...
### News Feed Building
   ...
   ![News Feed Building](/images/11-news-feed-system/news-feed-building.png)
...
2. **Fanout Service:**
   ...
   - **Hybrid Approach:** Use a push model for most users and a pull model for high-connection users (e.g., celebrities).
        ...
        ![Feed Publishing Deep Dive](/images/11-news-feed-system/feed-publishing-deep-dive.png)
    ...
    5. **Store in News Feed Cache:** Append new post IDs to the friends’ news feed cache. A configurable limit ensures that only recent posts are stored, as most users focus on the latest content, keeping cache memory consumption manageable.
        ...
        ![Fanout Service](/images/11-news-feed-system/fanout-service.png)
...
5. **Counter Cache:** Maintains counts for likes, replies, followers, etc.
    ...
    ![Cache Architecture](/images/11-news-feed-system/cache-architecture.png)
---
