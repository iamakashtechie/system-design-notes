---
title: Ch 15 · Design Google Drive
---
...
![Namespaces](/images/15-google-drive/namespaces.png)
...
2. **Amazon S3:** Use S3 for scalable and redundant file storage with cross-region replication.
    ...
    ![Replication](/images/15-google-drive/replication.png)
...
![Sync Conflicts](/images/15-google-drive/sync-conflicts.png)
...
### Improved design
![High Level Design](/images/15-google-drive/high-level-design.png)
...
![Metadata Database ](/images/15-google-drive/metadata-database.png)
...
![Upload Flow ](/images/15-google-drive/upload-flow.png)
...
1. **Delta Sync:** Transfer only modified blocks instead of the entire file.
    ...
    ![Delta Sync](/images/15-google-drive/delta-sync.png)
...
![File Synce ](/images/15-google-drive/file-sync.png)
...
![Upload Flow ](/images/15-google-drive/download-flow.png)
