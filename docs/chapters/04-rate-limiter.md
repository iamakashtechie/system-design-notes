---
title: Ch 4 · Design a Rate Limiter
---
...
### Placement Options
![Rate Limiting Middleware Architecture](/images/04-rate-limiter/rate_limiter_architecture.png)
...
### 1. Token Bucket
![Token Bucket Algorithm](/images/04-rate-limiter/token-bucket.png)
...
### 2. Leaking Bucket
![Leaking Bucket Algorithm](/images/04-rate-limiter/leaking-bucket.png)
...
![Fixed Window Counter](/images/04-rate-limiter/fixed-window-counter.png)
...
could cause more requests than allowed quota to go through.
  ...
  ![Fixed Window Issue](/images/04-rate-limiter/fixed-window-issue.png)


### 4. Sliding Window Log
![Sliding Window Log](/images/04-rate-limiter/sliding-window-log.png)
...
![Fixed Window Counter](/images/04-rate-limiter/sliding-window-counter.png)
...
<img src="/images/04-rate-limiter/architecture.png" style="margin-left: 40px; margin-top: 40px; margin-bottom: 20px;" alt="Architecture" width="550">
