---
title: Ch 13 · Design a Search Autocomplete System
---
...
![Data Gathering](/images/13-search-autocomplete/data-gathering.png)
...
### Query Service
![Frequency Table](/images/13-search-autocomplete/frequency-table.png)
    ![Search Suggestions](/images/13-search-autocomplete/basic-search-suggestions.png)
...
4. **Steps to get top k most searched queries**
   ![Trie Structure](/images/13-search-autocomplete/trie-structure.png)
...
3. **Optimizations:**
   - Cache top-k queries at each node to speed up retrieval and avoid traversing the whole trie.
        ...
        ![Cached Trie](/images/13-search-autocomplete/cached-trie.png)
...
3. **Delete:** 
      ![Delete KV](/images/13-search-autocomplete/delete-kv.png)
...
![Updated Data Gathering Flow](/images/13-search-autocomplete/data-gathering-flow.png)
    ...
    - **Trie DB** 
        ...
        2. **Key-Value Store:** 
            ...
            - Data on each trie node is mapped to a value in a hash table.
                ...
                ![Trie DB](/images/13-search-autocomplete/trie-db.png)
---
...
2. **Load Balancing:**
   ![Sharding](/images/13-search-autocomplete/sharding.png)
