---
title: Ch 25 · Real-time Gaming Leaderboard
---
...
![leaderboard](/images/25-gaming-leaderboard/leaderboard.png)
...
![high-level-architecture](/images/25-gaming-leaderboard/high-level-architecture.png)
...
![alternative-design](/images/25-gaming-leaderboard/alternative-design.png)
...
![message-queue-based-comm](/images/25-gaming-leaderboard/message-queue-based-comm.png)
...
![leaderboard-table](/images/25-gaming-leaderboard/leaderboard-table.png)
...
![user-wins-point](/images/25-gaming-leaderboard/user-wins-point.png)
...
![find-leaderboard-position](/images/25-gaming-leaderboard/find-leaderboard-position.png)
...
![sorted-set](/images/25-gaming-leaderboard/sorted-set.png)
...
![skip-list](/images/25-gaming-leaderboard/skip-list.png)
...
![skip-list-performance](/images/25-gaming-leaderboard/skip-list-performance.png)
...
![leaderboard-position-of-user](/images/25-gaming-leaderboard/leaderboard-position-of-user.png)
...
![manage-services-ourselves](/images/25-gaming-leaderboard/manage-services-ourselves.png)
...
![api-gateway-mapping](/images/25-gaming-leaderboard/api-gateway-mapping.png)
...
![user-scoring-point-lambda](/images/25-gaming-leaderboard/user-scoring-point-lambda.png)

Example user retrieving leaderboard:

![user-retrieve-leaderboard](/images/25-gaming-leaderboard/user-retrieve-leaderboard.png)
...
![range-partition](/images/25-gaming-leaderboard/range-partition.png)
...
![hash-partition](/images/25-gaming-leaderboard/hash-partition.png)
...
![top-10-players-calculation](/images/25-gaming-leaderboard/top-10-players-calculation.png)
...
![dynamo-db](/images/25-gaming-leaderboard/dynamo-db.png)

Let's start from a table for storing a leaderboard for a chess game:

![chess-game-leaderboard-table-1](/images/25-gaming-leaderboard/chess-game-leaderboard-table-1.png)

This works well, but doesn't scale well if we need to query anything by score. Hence, we can put the score as a sort key:

![chess-game-leaderboard-table-2](/images/25-gaming-leaderboard/chess-game-leaderboard-table-2.png)
...
![chess-game-leaderboard-table-3](/images/25-gaming-leaderboard/chess-game-leaderboard-table-3.png)
...
![scatter-gather-2](/images/25-gaming-leaderboard/scatter-gather-2.png)
